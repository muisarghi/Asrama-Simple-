        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-12">
				...
				<div class="card">
					...
					<strong>Form Paket Keluar </strong>
					</div>
					...
					<div class="row form-group">
						...
						<input type="text" id="text-input" name="nama_paket" placeholder="" class="form-control">
						</div>
					...
					<input type="hidden" name="add" value="pktklr">
					<input type="hidden" name="jns_paket" value="keluar">
